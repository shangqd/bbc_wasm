...
void shang_test1()
      {
         ...
         eosio::chain::wasm_injections::wasm_binary_injection injector(module);
         injector.inject();
         ...
         eosio::chain::webassembly::wabt_runtime::shang_test2((const char*)bytes.data(), bytes.size(), parse_initial_memory(module));
      }
